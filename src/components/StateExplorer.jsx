...
const DISPLAY_PATTERN = {
  ...
  'Growth under environmental stress': 'Growth Under Environmental Stress',
  'Overall deterioration': 'Overall Deterioration',
  'Environmental recovery, tourism weakness': 'Environmental Improvement / Economic Weakness',
};
const PATTERN_ORDER = [
  ['Sustainable improvement', 'Economic ↑ · Environmental ↑'],
  ['Growth under environmental stress', 'Economic ↑ · Environmental ↓'],
  ['Overall deterioration', 'Economic ↓ · Environmental ↓'],
  ['Environmental recovery, tourism weakness', 'Economic ↓ · Environmental ↑'],
];
